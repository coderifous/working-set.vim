" I don't think we need to keep support for vim7 around, but I'm going to
" comment it out for now.  If it's valuable to keep around, it will need to be
" updated to work with the JSON api.
"
" if v:version < 800
"
" ruby <<EOF
